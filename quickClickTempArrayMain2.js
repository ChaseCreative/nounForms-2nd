...
nounsSecondSing = [["serv", "servant"], ["hort", "garden"], ["lect", "couch"], ["coqu", "cook"], ["cerv", "deer"],["cib", "food"], ["anul", "ring"], ["domin", "master"], ["candidat", "candidate"],["lup", "wolf"]];
nounsSecondSingIndx = Math.floor(Math.random() * nounsSecondSing.length);

nounsSecondPl = [["serv", "servants"], ["hort", "gardens"], ["lect", "couches"], ["argentari", "bankers"], ["coqu", "cooks"], ["cerv", "deer"],["cib", "food"], ["anul", "rings"], ["nunti", "messengers"], ["fili", "sons"],["domin", "masters"], ["venalici", "slave dealers"], ["candidat", "candidates"],["lup", "wolves"],["puer", "boys"], ["libr", "books"], ["magistr", "teachers"],["vir","men"]];
nounsSecondPlIndx = Math.floor(Math.random() * nounsSecondPl.length);


  //var verbsFirstPer = [["Amav", "loved"], ["laborav", "worked"], ["habitav", "lived"], ["cogitav", "thought"], ["cantav", "sang"], ["ded", "gave"]];


pESecondSing = [["us", "the "], ["ī (Genitive)", "of the "], ["ō (Dative)", "to/for the "], ["um", "the "], ["ō (Ablative)", "by/with/in/from the "], ["e!", "Oh, "]];
pESecondSingIndx = Math.floor(Math.random() * pESecondSing.length);

pESecondPl = [["ī (Nominative)", "the "], ["ōrum ", "of the "], ["īs (Dative)", "to/for the "], ["ōs", "the "], ["īs (Ablative)", "by/with/in/from the "], ["ī! (Vocative)", "Oh, "]];
pESecondPlIndx = Math.floor(Math.random() * pESecondPl.length);

nounsSingLatinArray = nounsSecondSing[nounsSecondSingIndx][0] + pESecondSing[pESecondSingIndx][0];
nounsSingTransArray = pESecondSing[pESecondSingIndx][1] + nounsSecondSing[nounsSecondSingIndx][1];

nounsPlLatinArray = nounsSecondPl[nounsSecondPlIndx][0] + pESecondPl[pESecondPlIndx][0];
nounsPlTransArray = pESecondPl[pESecondPlIndx][1] + nounsSecondPl[nounsSecondPlIndx][1];
